...
**NOTE** This requires python 3.8+ [Installation Guide](https://www.python.org/downloads/)

*_You can use any of the following_*
...
4. Download with PowerShell (ONLY ON WINDOWS!)
 - Press `windows + r`
